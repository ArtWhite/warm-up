...
public class Main {
    public static void main(String[] args) {
        ...
        checkProfit(project1, timeOfProject1);
        Integer project2[] = {11, 2};
        Arrays.sort(project2, Collections.reverseOrder());
        int timeOfProject2 = 4;
        checkProfit(project2, timeOfProject2);
        Integer project3[] = {8, 2, 9, 17, 4, 4, 10};
        int timeOfProject3 = 4;
        checkProfit(project3, timeOfProject3);
    }

    private static void checkProfit(Integer[] arr, int time) {
        int res = 0;
        int upTo;
